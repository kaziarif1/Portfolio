    ...
    <section id="contact" className="py-24 px-4 relative bg-secondary/30">
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex flex-col text-left">
                  ...
                  <a
                    href="mailto:kajarif02@gmail.com"
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex flex-col text-left">
                  ...
                  <a
                    href="https://www.google.com/maps/search/?api=1&query=Tilagor,+Sylhet,+Bangladesh"
                    target="_blank"
          ...
          {/* RIGHT SIDE: Form */}
          <div className="bg-card p-6 rounded-lg shadow-xs max-w-md w-full mx-auto md:mx-0">
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <input
                  type="email"
                  required
                  placeholder="kajarif02@gmail.com"
                  className="w-full px-3 py-2 rounded-md border border-input bg-background focus:outline-none focus:ring-2 focus:ring-primary"
                />
              </div>
              ...
              <button
                ...
                className={cn(
                  "cosmic-button w-full flex items-center justify-center gap-2 py-2"
                )}
              >
